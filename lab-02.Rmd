...
author: "Table 11: Jamie Burrell, Taoran Wang, Tianqi Zheng, Yankun Shen, Chenghui Wu and Hani Malang"
date: "`r Sys.Date()`"
...
```{r Ex1, message = FALSE}
frequency_table <- table(plastic_data_all)
print(frequency_table)
max_region <- names(which.max(frequency_table))
print(max_region)
